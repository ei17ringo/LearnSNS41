...
if (isset($_GET["user_id"])){
  ...
  // 上のようなURLでアクセスされたときは、$_GET["user_id"]が存在しないので、$_SESSION["id"](ログインしてる人のid)を使用する
  $user_id = $_SESSION["id"];
    ...
    <div class="row">
      <div class="col-xs-3 text-center">
        ...
        <?php if ($user_id != $_SESSION["id"]){ ?>
          ...
          <?php }else{ ?>
            <a href="unfollow.php?follower_id=<?php echo $profile_user["id"]; ?>"><button class="btn btn-default btn-block">フォロー解除する</button></a>
